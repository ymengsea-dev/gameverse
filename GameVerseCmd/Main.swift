...
@main
struct GameVerse: ParsableCommand {
    static let configuration = CommandConfiguration(
        abstract: "A CLI interface for GameVerse.",
...
//            print("Create a bottle")
    ...
    struct Remove: ParsableCommand {
        static let configuration = CommandConfiguration(abstract: "Remove an existing bottle from GameVerse.",
    ...
    struct Run: ParsableCommand {
        static let configuration = CommandConfiguration(abstract: "Run a program with GameVerse.")
    ...
    struct Install: ParsableCommand {
        static let configuration = CommandConfiguration(abstract: "Install GameVerseWine.")
    ...
    struct Uninstall: ParsableCommand {
        static let configuration = CommandConfiguration(abstract: "Uninstall GameVerseWine.")

        @Flag(name: [.long, .short], help: "Uninstall GameVerseWine") var whiskyWine = false
